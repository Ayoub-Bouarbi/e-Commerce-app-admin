          ...
          <div class="leading-loose lg:w-2/3">
            <div class="p-10">
              <div>
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 border border-gray-600 rounded" v-model="data.name"
                  id="name" name="name" type="text" required placeholder="Product Name">
              </div>
              <div class="grid grid-cols-2 gap-4">
                <div>
                  <label class="block text-sm text-gray-600" for="name">SKU</label>
                  <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 border border-gray-600 rounded" v-model="data.sku"
                    id="sku" name="sku" type="text" required placeholder="Product Sku">
                </div>
                <div>
              ...
              <div>
                ...
                <v-select class="text-black" v-model="data.categories_id" as="name:id:id" :from="categories"
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 border border-gray-600 rounded"
                    v-model="data.quantity" id="quantity" name="quantity" type="number" required placeholder="Product Quntity">
                </div>
                <div>
